	...
	,m_evtTableLastDays(7)
{
	...
	m_clientTable = new ParkinglotsSvr::st_client_table (m_netEngine,
													m_taskEngine,
													m_pDatabases,
													m_pClusterTerm,
													this);
	connect (m_clientTable,&ParkinglotsSvr::st_client_table::evt_Message,this,&ZPMainFrame::on_evt_Message_Smartlink);
